...
<head>
  ...
  <meta name="description" content="Tambah kategori baru admin Talenta Florist." />
    ...
    <div class="panel panel--narrow">
      ...
      <form method="post">
        <div class="form-group">
          ...
          <input type="text" name="nama" id="inp-nama" value="<?= htmlspecialchars($_POST['nama'] ?? '') ?>" required />
        </div>
        <div class="form-group">
          <label>Slug (huruf kecil, tanpa spasi) *</label>
          <input type="text" name="slug" id="inp-slug" value="<?= htmlspecialchars($_POST['slug'] ?? '') ?>" required placeholder="cth: rangkaian" />
